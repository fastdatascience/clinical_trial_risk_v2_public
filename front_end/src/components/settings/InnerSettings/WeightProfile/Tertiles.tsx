...
const TABLE_HEAD = ["Condition", "Phase", "Lower Tertile", "Upper Tertile", ""];

// Rename this to Tertiles, we need to have drop down here with tertiles as optons and on select it should siaply that tertile
const Tertiles = () => {
