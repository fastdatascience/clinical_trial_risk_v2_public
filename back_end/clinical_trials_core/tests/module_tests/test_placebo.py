...
class TestPlacebo(unittest.TestCase):
    ...
    def test_short(self):
        document = Document(
            pages=[
                Page(
                    content="The placebo group of 6 patients received drug TID at morning. placebo placebo placebo placebo placebo placebo placebo placebo placebo",
                    page_number=1,
                ),
                Page(
                    content="The placebo group of 6 patients received drug TID at morning. placebo placebo placebo placebo placebo placebo placebo placebo placebo",
