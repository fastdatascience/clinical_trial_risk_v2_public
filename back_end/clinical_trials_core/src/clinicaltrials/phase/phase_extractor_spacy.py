...
phase_map = {"Early Phase 1": 0.5, "Not Applicable": 0, "Phase 1": 1, "Phase 1/Phase 2": 1.5, "Phase 2": 2, "Phase 2/Phase 3": 2.5, "Phase 3": 3, "Phase 4": 4}
...
class PhaseExtractorSpacy:
    def __init__(self, path_to_classifier):
        if not exists(path_to_classifier):
            print(f"WARNING! UNABLE TO LOAD PHASE CLASSIFIER {path_to_classifier}. You need to run the training script.")
            self.nlp = None
            return
