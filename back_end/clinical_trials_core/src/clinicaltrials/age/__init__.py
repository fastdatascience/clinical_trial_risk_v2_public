...
patterns["age years"] = ["# years old", "# year old", "#-year-old", "# year-old", "age # years", "aged # years", "age: # years", "aged: # years"]

patterns["between years"] = ["# and # years", "# to # years", "#-# years", "# - # years", "# and # year", "# to # year", "#-# year", "# - # year"]
...
patterns["exclusions"] = ["for #", "during #", "within #", "period of #", "every #", "after #", "for a minimum of #", "last #", "past #"]
...
class Age(BaseProcessor):
    def __init__(self) -> None:
        ...
        self.feature_names = [
            "x0_lower_value_years",
            "x1_upper_value_years",
            "x2_num_values",
    ...
    def process(self, document: Document, config: ClassifierConfig | None = None):
        ...
        if len(candidates) > 0:
            ...
            candidates_with_scores = []
        return {"prediction": prediction, "candidates": candidates, "candidates_with_scores": candidates_with_scores, "annotations": annotations, "pages": occurrence_to_pages}
...
if __name__ == "__main__":
    ...
    with open("/home/thomas/clinical_trials/data/ctgov/preprocessed_tika/76_NCT02006576_Prot_SAP_000.pdf.pkl", "rb") as f:
        pages = pkl.load(f)

    document = Document(pages=[Page(content=p, page_number=idx + 1) for idx, p in enumerate(pages)])
